...
\makeevenhead{custom}{\textit{\assignmentName}}{}{\textit{\writerName}} % Definerer lige siders sidehoved efter modellen \makeevenhead{Navn}{Venstre}{Center}{Højre}
\makeoddhead{custom}{\textit{\writerName}}{}{\textit{\assignmentName}} % Definerer ulige siders sidehoved efter modellen \makeoddhead{Navn}{Venstre}{Center}{Højre}
...
\makeevenfoot{custom}{Page \thepage}{}{\institutionName}	% Definerer lige siders sidefod efter modellen \makeevenfoot{Navn}{Venstre}{Center}{Højre}
\makeoddfoot{custom}{\institutionName}{}{Page \thepage}% Definerer ulige siders sidefod efter modellen \makeoddfoot{Navn}{Venstre}{Center}{Højre}		
...
\makeoddhead{nychapter}{\textit{\writerName}}{}{\textit{\assignmentName}}
\makeevenhead{nychapter}{\textit{\writerName}}{}{\textit{\assignmentName}}
%\makeevenhead{nychapter}{\writerName}{\assignmentName}{\leftmark}
...
\noindent \textsc{\parbox[t]{2cm}{Acceptance\\Tests:}} & \vspace{-7mm} #5\\
\end{tabularx}
\end{table}
}
